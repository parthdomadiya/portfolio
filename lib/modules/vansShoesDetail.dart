...
class VansShoesDetailScreen extends StatefulWidget {
  @override
  _VansShoesDetailScreenState createState() => _VansShoesDetailScreenState();
}

class _VansShoesDetailScreenState extends State<VansShoesDetailScreen> {
  @override
