...
class PumaShoesDetailScreen extends StatefulWidget {
  @override
  _PumaShoesDetailScreenState createState() => _PumaShoesDetailScreenState();
}

class _PumaShoesDetailScreenState extends State<PumaShoesDetailScreen> {
  @override
