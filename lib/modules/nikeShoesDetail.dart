...
class NikeShoesDetailScreen extends StatefulWidget {
  @override
  _NikeShoesDetailScreenState createState() => _NikeShoesDetailScreenState();
}

class _NikeShoesDetailScreenState extends State<NikeShoesDetailScreen> {
  @override
